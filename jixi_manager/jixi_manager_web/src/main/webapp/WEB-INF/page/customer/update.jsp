    ...
    <form class="form form-horizontal" id="form-article-update">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" readonly="readonly" class="input-text" value="${customer.customercode}" placeholder="" id="customercode" name="customercode">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${customer.company}" placeholder="" id="company" name="company">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${customer.sellman}" placeholder="" id="sellman" name="sellman">
            </div>
        </div>
        <div class="row cl">
        ...
        $("#form-article-update").validate({
            ...
            submitHandler:function(form){
                ...
                if(customertype==0){
                    ...
                    $.post("/customer/update", $("#form-article-update").serialize(), function (data) {
                        console.info(data);
                    });
