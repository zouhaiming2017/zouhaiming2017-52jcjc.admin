...
<div class="page-container">
    <%--<div class="cl pd-5 bg-1 bk-gray mt-20">--%>
        <%--<span class="l">--%>
            ...
            <%--<a onclick="article_add('添加权限','/permission/add')" href="javascript:;" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加权限</a>--%>
        <%--</span>--%>
        <%--<span class="r">--%>
        <%--</span>--%>
    <%--</div>--%>
        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
            ...
            <c:forEach var="permission" items="${permissions}">
                <tr class="text-c">
                    ...
                    <%--<td class="f-14 td-manage"><a style="text-decoration:none" class="ml-5" onClick="article_edit('编辑','/permission/update','${permission.id}')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="article_del(this,'${permission.id}')"  href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>--%>
                </tr>
            </c:forEach>
            </tbody>
        </table>
...
<script type="text/javascript">
    ...
    function datadel() {
        ...
        layer.confirm('确认要删除id为'+checkedList.toString()+'的权限吗？',function(index){
            if(index) {
                $.post("/permission/delete", params, function (data) {
                    $("input[name='ck']:checked").each(function () {
                        // 找到选中的复选框所在的行
                        $tr = $(this).eq(0).parent().parent();
                        //删除页面被选中的节点数据
    ...
    function article_del(obj,id){
        layer.confirm('确认要删除id为'+id+'的权限吗？',function(index){
            if(index) {
                var param = {"id": id};
                $.post("/permission/deleteOne", param, function (data) {
