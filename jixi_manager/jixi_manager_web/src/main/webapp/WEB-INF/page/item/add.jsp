...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="brandname" name="brandname">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">包装规格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="packingsize" name="packingsize">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">计价单位：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="chargeunit" name="chargeunit">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="outprice" name="outprice">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="outcount" name="outcount">
            </div>
        </div>
    ...
    function article_save_submit(){
        ...
        $("#form-article-add").validate({
            ...
            submitHandler:function(form){
                $.post("/item/add", $("#form-article-add").serialize(), function (data) {
                    console.info(data);
                });
