...
<div class="text-c">
    <form action="/charts/charts-month" method="get">
            ...
            var option = {
                ...
                series : [
                    ...
                    },
                    {
                        ...
                        markPoint : {
                            data : [
                                {name : '月最高', value : ${maxCount}, xAxis: ${maxDay}, yAxis: ${maxCount}, symbolSize:18},
                                {name : '月最低', value : ${minCount}, xAxis: ${minDay}, yAxis: ${minCount}}
                            ]
                        },
                        markLine : {
                            data : [
