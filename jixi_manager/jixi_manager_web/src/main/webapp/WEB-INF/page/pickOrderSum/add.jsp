    ...
    <form class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="pickordercode" name="pickordercode">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="sum" name="sum">
            </div>
        </div>
        <div class="row cl">
    ...
    function article_save_submit(){
        ...
        $("#form-article-add").validate({
            ...
            submitHandler:function(form){
                $.post("/pickOrderSum/add", $("#form-article-add").serialize(), function (data) {
                    console.info(data);
                });
