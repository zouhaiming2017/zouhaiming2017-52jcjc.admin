...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="taxpoint" name="taxpoint">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="supplierindex" name="supplierindex">
            </div>
        </div>
    ...
    function article_save_submit(){
        ...
        $("#form-article-add").validate({
            ...
            submitHandler:function(form){
                $.post("/supplier/add", $("#form-article-add").serialize(), function (data) {
                    console.info(data);
                });
