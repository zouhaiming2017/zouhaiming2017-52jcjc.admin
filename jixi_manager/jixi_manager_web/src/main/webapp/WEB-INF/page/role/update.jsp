    ...
    <form action="" method="post" class="form form-horizontal" id="form-admin-role-update">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${role.id}" readonly="readonly" placeholder="" id="id" name="id">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${role.describes}" placeholder="" id="describes" name="describes">
            </div>
        </div>
...
//                var params = {"permissions": checkedList.toString()};
                $.post("/role/update?permissions="+checkedList.toString(), $("#form-admin-role-update").serialize(), function (data) {
                    console.info(data);
                });
