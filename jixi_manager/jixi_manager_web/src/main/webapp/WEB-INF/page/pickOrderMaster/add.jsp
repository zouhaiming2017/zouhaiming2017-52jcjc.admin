...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="supplier" name="supplier">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">供应商编码：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="suppliercode" name="suppliercode">
            </div>
        </div>
...
<script type="text/javascript">
    function article_save_submit(){
        ...
        $("#form-article-add").validate({
            ...
            $.post("/pickPriceMaster/add", $("#form-article-add").serialize(), function (data) {
            console.info(data);
        });
