...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-update">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">权限ID：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${permission.id}" placeholder="" id="id" name="id" readonly="readonly">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">字段名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${permission.fieldname}" placeholder="" id="fieldname" name="fieldname">
            </div>
        </div>
    ...
    function article_save_submit(){
        ...
        $("#form-article-update").validate({
            ...
            submitHandler:function(form){
                $.post("/permission/update", $("#form-article-update").serialize(), function (data) {
                    console.info(data);
                });
